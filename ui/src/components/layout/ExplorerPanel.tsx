...
export function ExplorerPanel({ open, view, onClose, className }: ExplorerPanelProps) {
      ...
      <div className="flex items-start justify-between gap-3 px-3 py-3">
        <div className="flex min-w-0 items-center gap-2.5">
          ...
          <div className="min-w-0">
            <div className="truncate text-body-sm font-semibold text-on-surface">{meta.title}</div>
            <div className="truncate text-caption text-on-surface-variant">{meta.eyebrow}</div>
          </div>
        </div>
  ...
  return (
    <div className="mt-3">
      <div className="flex items-center gap-1.5 px-1">
        ...
        <span className="text-caption font-semibold text-on-surface">Add Node</span>
        <span className="text-caption text-on-surface-variant/70">drag to canvas</span>
      </div>
...
function modelRows(nodes: Node[], models: ModelInfo[], loading: boolean): ExplorerRow[] {
