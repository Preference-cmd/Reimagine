...
/// Whether the request enables reasoning. The presence of `reasoning_effort`
/// in `options` marks the request as reasoning-enabled; the same trigger
/// stands in for Anthropic extended thinking in V1.
