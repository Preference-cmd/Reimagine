...
const VAE_SPECS: &[BurnTensorSpec] = &[
    ...
    BurnTensorSpec::required_rank(
        ...
        1,
        "decoder first residual norm weight (adapter converts to gamma)",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.0.norm1.bias",
        1,
        "decoder first residual norm bias (adapter converts to beta)",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.0.conv1.weight",
        4,
        "decoder first residual conv1 weight",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.0.conv1.bias",
        1,
        "decoder first residual conv1 bias",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.0.norm2.weight",
        1,
        "decoder first residual norm2 weight (adapter converts to gamma)",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.0.norm2.bias",
        1,
        "decoder first residual norm2 bias (adapter converts to beta)",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.0.conv2.weight",
        4,
        "decoder first residual conv2 weight",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.0.conv2.bias",
        1,
        "decoder first residual conv2 bias",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.1.norm1.weight",
        1,
        "decoder second residual norm weight (adapter converts to gamma)",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.1.norm1.bias",
        1,
        "decoder second residual norm bias (adapter converts to beta)",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.1.conv1.weight",
        4,
        "decoder second residual conv1 weight",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.1.conv1.bias",
        1,
        "decoder second residual conv1 bias",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.1.norm2.weight",
        1,
        "decoder second residual norm2 weight (adapter converts to gamma)",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.1.norm2.bias",
        1,
        "decoder second residual norm2 bias (adapter converts to beta)",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.1.conv2.weight",
        4,
        "decoder second residual conv2 weight",
    ),
    BurnTensorSpec::required_rank(
        "mid_block.resnets.1.conv2.bias",
        1,
        "decoder second residual conv2 bias",
    ),
